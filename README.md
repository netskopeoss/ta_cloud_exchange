...
- Download the latest version of OVA from this [link](https://cloud-exchange-store.s3.us-east-1.amazonaws.com/cloudexchange/ova/cloud-exchange-5.1.2-20250702.ova).
